    ...
    <section className="py-20 md:py-28 bg-saree-silk/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <p className="font-serif text-sm italic text-saree-gold mb-3 tracking-wide">Handpicked for you</p>
            <h2 className="section-title">Featured Sarees</h2>
            <div className="divider-gold mt-4 ml-0" style={{ margin: '16px 0 0 0' }} />
          </div>
          <Link
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="font-serif text-stone-400 italic">No featured products at the moment.</p>
          </div>
        ) : (
