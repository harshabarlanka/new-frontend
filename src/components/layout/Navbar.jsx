          ...
          <nav className="px-4 py-6 flex flex-col gap-4">
            ...
            <div className="pt-2 border-t border-stone-200 flex flex-col gap-3">
              {user ? (
                <>
                  {isAdmin && (
                    <Link to="/admin" className="text-sm tracking-wider uppercase text-stone-700 hover:text-saree-gold">
                      Admin Dashboard
                    </Link>
                  )}
                  <button
                ...
                <>
                  <Link to="/login" className="text-sm tracking-wider uppercase text-stone-700 hover:text-saree-gold">
                    Sign In
                  </Link>
                  <Link to="/register" className="text-sm tracking-wider uppercase text-saree-gold">
                    Create Account
                  </Link>
                </>
              )}
