      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <h3 className="font-display text-3xl text-white mb-2">Aavaran</h3>
            <p className="font-serif text-sm italic text-saree-gold mb-4">premium sarees</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Kanjeevaram', 'Banarasi', 'Pochampally', 'Gadwal', 'Uppada', 'Bandhani', 'Chanderi'].map((cat) => (
                <li key={cat}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Our Story', 'Artisans', 'Sustainability', 'Press', 'Careers'].map((item) => (
                <li key={item}>
                  <a href="#" className="font-sans text-sm text-stone-400 hover:text-saree-gold transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <a href="mailto:hello@aavaran.in" className="font-sans text-sm text-saree-gold hover:text-white transition-colors">
                hello@aavaran.in
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-stone-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-sans text-xs text-stone-500">
            © {new Date().getFullYear()} Aavaran. All rights reserved.
          </p>
