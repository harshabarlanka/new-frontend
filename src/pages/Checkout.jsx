...
const CheckoutPage = () => {
    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center">
        <div className="text-center">
          <p className="font-display text-2xl text-saree-deep mb-4">Please sign in to checkout</p>
  ...
  if (items.length === 0 && step !== 'success') {
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center">
        <div className="text-center">
          <p className="font-display text-2xl text-saree-deep mb-4">Your cart is empty</p>
    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center bg-stone-50">
        <div className="bg-white rounded-2xl shadow-sm p-10 max-w-md w-full mx-4 text-center">
          ...
          <h2 className="font-display text-3xl text-saree-deep mb-2">Order Placed!</h2>
          <p className="font-sans text-stone-500 mb-2">Thank you for your purchase.</p>
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-stone-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-display text-4xl text-saree-deep mb-10">Checkout</h1>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Address Form */}
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="font-display text-xl text-saree-deep mb-6">Shipping Address</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-28">
              <h2 className="font-display text-xl text-saree-deep mb-5">Your Order</h2>
                ...
                {items.map((item) => {
                  ...
                  return (
                    <div key={item._id} className="flex gap-3">
                      <img
                        src={p.images?.[0] || 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=80'}
                        alt={p.name}
                        className="w-14 h-18 object-cover rounded-lg flex-shrink-0"
                      />
                      <div className="flex-1 min-w-0">
                        <p className="font-sans text-sm text-saree-deep line-clamp-2">{p.name}</p>
                        <p className="font-sans text-xs text-stone-400 mt-0.5">Qty: {item.quantity}</p>
              ...
              <p className="font-sans text-xs text-stone-400 text-center mt-3">Free shipping · Test mode</p>
            </div>
          </div>
        </div>
      </div>
