  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-stone-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="font-display text-4xl text-saree-deep mb-2">
          Shopping Cart
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-28">
              ...
              {/* ── Shipping threshold constants (must match server orderController) ── */}
              {(() => {
                ...
                return (
                  <div className="space-y-3 font-sans text-sm">
                    ...
                    {shippingCost === 0 && subtotal >= FREE_THRESHOLD && (
                      <p className="text-xs text-green-600 flex items-center gap-1">
                        <span>✓</span> You get free shipping on this order!
                      </p>
                    )}
